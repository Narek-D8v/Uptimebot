...
def setup_routes(app: web.Application):
    ...
    r.add_post('/', handle_root)
    r.add_get('/webapp', handle_webapp_index)
    r.add_static('/webapp/', path='webapp', show_index=True)
    r.add_get('/api/v1/user', handle_api_user)
    r.add_get('/api/v1/monitors', handle_api_monitors_list)
    r.add_get('/api/v1/monitors/{id}', handle_api_monitor_detail)
    r.add_post('/api/v1/monitors', handle_api_monitor_create)
    r.add_patch('/api/v1/monitors/{id}', handle_api_monitor_update)
    r.add_delete('/api/v1/monitors/{id}', handle_api_monitor_delete)
    r.add_get('/api/v1/monitors/{id}/checks', handle_api_monitor_checks)
    ...
    r.add_post('/api/v1/monitors/reorder', handle_api_monitors_reorder)
    r.add_get('/api/v1/stats', handle_api_stats)
    r.add_get('/{path:.*}', handle_heartbeat)
    r.add_post('/{path:.*}', handle_heartbeat)
